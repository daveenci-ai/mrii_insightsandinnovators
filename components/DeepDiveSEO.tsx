...
import { CheckCircle2, TrendingUp, Cpu, Award, Mic, Users, Globe } from 'lucide-react';
  ...
  return (
    <section className="py-24 bg-white relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-20">
          ...
          >
            ...
            <p className="text-xl text-gray-600 leading-relaxed font-medium">
              Produced by the Market Research Institute International (MRII) in collaboration with the University of Georgia, 
              this podcast is the definitive audio resource for professionals seeking to advance their careers.
            </p>
          </motion.div>
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-gray-600 text-lg leading-relaxed mb-8">
                In an era where data privacy, behavioral science, and predictive modeling are moving at the speed of light, 
                the <strong>Insights & Innovators</strong> podcast provides a curated, expert-led roadmap. Our content is 
                specifically designed for Insights Leaders, Data Innovators, and anyone enrolled in the 
                <em> Principles of Market Research</em> or <em>Principles of Data Insights</em> programs.
              </p>
        ...
        <div className="space-y-24 mb-24">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <p className="text-lg text-gray-600 leading-relaxed mb-6">
                As the industry evolves, so do the standards of excellence. We discuss the changing landscape of 
                research education, continuing education requirements, and how to maintain the highest ethical 
                standards in a globally connected market.
              </p>
        ...
        >
          {[
            { label: "Years of Excellence", value: "35+", color: "bg-gray-50 text-primary" },
            { label: "Professionals Trained", value: "9k+", color: "bg-primary text-white" },
            { label: "Global Sponsors", value: "100+", color: "bg-gray-900 text-white" },
            { label: "UGA Collaboration", value: "Partner", color: "bg-gray-50 text-gray-900", icon: <CheckCircle2 className="text-primary" /> }
          ].map((stat, i) => (
